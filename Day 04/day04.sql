...
**Question:** Find the 3rd to 7th highest patient satisfaction scores from the patients table, showing patient_id, name, 
...
--SELECT patient_id, name FROM patients LIMIT 5;

--2. Show patients 11-20 using OFFSET.
--SELECT patient_id, name FROM patients LIMIT 10 OFFSET 10;
